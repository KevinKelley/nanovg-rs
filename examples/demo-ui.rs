...
use nanovg::{Direction, Alignment, Color, Style, Font, Frame,
             LineCap, LineJoin, Paint, PathOptions, Scissor, Solidity, StrokeOptions,
...
fn draw_eyes(frame: &Frame, x: f32, y: f32, w: f32, h: f32, mx: f32, my: f32, t: f32) {
    ...
    frame.path(
        |path| {
            ...
            path.fill(Style::Color(Color::from_rgba(32, 32, 32, 255)), Default::default());
        },
        Default::default(),
    );
...
fn draw_graph(frame: &Frame, x: f32, y: f32, w: f32, h: f32, t: f32) {
    ...
    frame.path(
        |path| {
            ...
            path.stroke(
                Style::Color(Color::from_rgba(0, 0, 0, 32)),
                StrokeOptions {
                    width: 3.0,
                    ..Default::default()
                }
    ...
    frame.path(
        |path| {
            ...
            path.stroke(
                Style::Color(Color::from_rgba(0, 160, 192, 255)),
                StrokeOptions {
                    width: 3.0,
                    ..Default::default()
                }
    ...
    frame.path(
        |path| {
            ...
            path.fill(Style::Color(Color::from_rgba(0, 160, 192, 255)), Default::default());
        },
        Default::default(),
    );
...
fn draw_color_wheel(frame: &Frame, x: f32, y: f32, w: f32, h: f32, t: f32) {
                ...
                path.fill(
                    Style::Paint(
                        Paint::with_linear_gradient(
                            ...
                            Color::from_hsla(a1 / (consts::PI * 2.0), 1.0, 0.55, 255),
                        )
                    ),
                    Default::default()
                );
    ...
    frame.path(
        |path| {
            ...
            path.stroke(
                Style::Color(Color::from_rgba(0, 0, 0, 64)),
                StrokeOptions {
                    width: 1.0,
                    ..Default::default()
                }
    ...
    frame.path(
        |path| {
            ...
            path.stroke(
                Style::Color(Color::from_rgba(255, 255, 255, 192)),
                StrokeOptions {
                    width: 2.0,
                    ..Default::default()
                }
        ...
        for j in 0..joins.len() {
            ...
            frame.path(
                |path| {
                    ...
                    path.stroke(
                        Style::Color(Color::from_rgba(0, 0, 0, 160)),
                        StrokeOptions {
                            width: s * 0.3,
                            line_cap: cap,
                            line_join: join,
            ...
            frame.path(
                |path| {
                    ...
                    path.stroke(
                        Style::Color(Color::from_rgba(0, 192, 255, 255)),
                        StrokeOptions {
                            width: 1.0,
                            line_cap: cap,
                            line_join: join,
    ...
    for i in 0..20 {
        ...
        frame.path(
            |path| {
                ...
                path.stroke(
                    Style::Color(Color::from_rgba(0, 0, 0, 255)),
                    StrokeOptions {
                        width: w,
                        ..Default::default()
                    }
...
fn draw_caps(frame: &Frame, x: f32, y: f32, width: f32) {
    ...
    frame.path(
        |path| {
            ...
            path.fill(Style::Color(Color::from_rgba(255, 255, 255, 32)), Default::default());
        },
        Default::default(),
    );
...
fn draw_scissor(frame: &Frame, x: f32, y: f32, t: f32) {
    ...
    frame.path(
        |path| {
            ...
            path.fill(Style::Color(Color::from_rgba(255, 0, 0, 255)), Default::default());
        },
        PathOptions {
    ...
    frame.path(
        |path| {
            ...
            path.fill(Style::Color(Color::from_rgba(255, 128, 0, 64)), Default::default());
        },
        PathOptions {
    ...
    frame.path(
        |path| {
            path.rect((-20.0, -10.0), (60.0, 30.0));
            path.fill(Style::Color(Color::from_rgba(255, 128, 0, 255)), Default::default());
        },
        PathOptions {
            clip: Clip::Intersect(
                Intersect {
...
fn draw_window(frame: &Frame, fonts: &DemoFonts, title: &str, x: f32, y: f32, w: f32, h: f32) {
    ...
    frame.path(
        |path| {
            ...
            path.fill(Style::Color(Color::from_rgba(28, 30, 34, 192)), Default::default());
        },
        Default::default(),
    );
    ...
    frame.path(
        |path| {
            ...
            path.stroke(Style::Color(Color::from_rgba(0, 0, 0, 32)), Default::default());
        },
        Default::default(),
    );
...
fn draw_slider(frame: &Frame, value: f32, x: f32, y: f32, w: f32, h: f32) {
    ...
    frame.path(
        |path| {
            ...
            path.fill(Style::Color(Color::from_rgba(40, 43, 48, 255)), Default::default());
    ...
    frame.path(
        |path| {
            ...
            path.stroke(Style::Color(Color::from_rgba(0, 0, 0, 92)), Default::default());
        },
        Default::default(),
    );
}
...
fn draw_thumbnails(frame: &Frame, images: &Vec<Image>, x: f32, y: f32, w: f32, h: f32, t: f32) {
    ...
    frame.path(
        |path| {
            ...
            path.line_to((x + 1.0, y + arry + 11.0));
            path.fill(Style::Color(Color::from_rgba(200, 200, 200, 255)), Default::default());
        },
        Default::default()
    );
    ...
    frame.path(
        |path| {
            ...
            path.fill(
                Style::Paint(Paint::with_linear_gradient(
                        (x, y),
                        (x, y + 6.0),
                        Color::from_rgba(200, 200, 200, 255),
                        Color::from_rgba(200, 200, 200, 0),
                    )
                ),
                Default::default()
            );
...
impl PerformanceGraph {
    ...
    fn draw(&self, frame: &Frame, font: Font, x: f32, y: f32) {
        ...
        frame.path(
            |path| {
                path.rect((x, y), (w, h));
                path.fill(Style::Color(Color::from_rgba(0, 0, 0, 128)), Default::default());
            },
            Default::default()
        );
        ...
        frame.path(
            |path| {
                ...
                path.fill(Style::Color(Color::from_rgba(255, 192, 0, 128)), Default::default());
            },
            Default::default()
        );
